...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#editClueBtn").click(function () {
			$.ajax({
				url:"workbench/clue/getUserListAndClue",
				data:{
					"id":"${c.id}"
				},
				type:"get",
		...
		$("#updateClueBtn").click(function () {
			$.ajax({
				...
				success:function (data) {
					if (data){
						window.location.href="workbench/clue/detail?id=${c.id}"
					}else {
						alert("修改失败")
					}
				}
			...
			$.ajax({
				...
				success:function (data) {
					if (data.success){
						...
						html += '<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}</b> <small id="s'+data.cr.id+'" style="color: gray;"> '+data.cr.createTime+' 由'+data.cr.createBy+'</small>';
						html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
						html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" onclick="editRemark(\''+data.cr.id+'\',\''+data.cr.noteContent+'\')" style="font-size: 20px; color: #FF0000;"></span></a>';
						html += '&nbsp;&nbsp;&nbsp;&nbsp';
		...
		$("#aName").keydown(function (event) {
			...
			if (event.keyCode == 13){
				$.ajax({
					url:"workbench/clue/getActivityByNameAndNotByCid",
					data:{
		...
		$("#bundBtn").click(function () {
			...
			if ($xz.length == 0){
				...
				// workbench/clue/bund?clueId=xxx&aid=xxx&aid=xxx
				var param = "cid=${c.id}&";
				...
				$.ajax({
					...
					success:function (data) {
						if (data){
							// 刷新关联市场活动列表
							showActivityList();
							// 清除搜索框中的信息，复选框中的✔ 清空activitySearchBody中的内容
							$("#aName").val("");
		...
		// 关联市场活动模态窗口点击取消，清除搜索框中的信息，复选框中的✔ 清空activitySearchBody中的内容
		$("#cancleBundBtn").click(function () {
			$("#aName").val("");
			$("#qx").prop("checked",false);
			$("input[name=xz]:checked").prop("checked",false);
			$("#activitySearchBody").html("");
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html += '<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}</b> <small id="s'+n.id+'" style="color: gray;"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
	...
	function showActivityList() {
		$.ajax({
			url:"workbench/clue/getActivityListByCid",
			data:{
				"clueId":"${c.id}"
			},
			type:"get",
	...
	function unbund(id) {// 参数为关联关系表的id
		if (confirm("确定解除市场活动关联")){
			$.ajax({
				url:"workbench/clue/unbund",
				data:{
					"id":id // 关联关系表的id
				},
				type:"post",
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" id="cancleBundBtn" >取消</button>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/getClueOnConvert?id=${c.id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: 40px; left: 40px;" id="remarkBody">
		<div class="page-header" id="remarkDiv2">
			<h4>备注</h4>
		</div>
